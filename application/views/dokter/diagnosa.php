<div class="container mb-container">
    <div class="row mt-5 mx-5 p-5 shadow bg-white rounded">
        <h1 class="text-center">Tambah Diagnosa dan Obat</h1>
        <div class="container text-center overflow-auto">
        <?php if (isset($rekam_medis)) : ?>
            <?php foreach ($rekam_medis as $data) : ?>
            <form name="sentMessage" id="contactForm" action="<?= base_url() ?>dokter/EditPost/<?= $data['id_rekammedis'] ?>" method="POST" novalidate>
